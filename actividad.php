...
function Validar(){
	...
	var FechaInicio = document.getElementById("FechaInicio").value + ' ' + document.getElementById("HoraInicio").value;
	var FechaInicioEjecucion = document.getElementById("FechaInicioEjecucion").value + ' ' + document.getElementById("HoraInicioEjecucion").value;
	
	var FechaFin = document.getElementById("FechaFin").value + ' ' + document.getElementById("HoraFin").value;
	var FechaFinEjecucion = document.getElementById("FechaFinEjecucion").value + ' ' + document.getElementById("HoraFinEjecucion").value;
