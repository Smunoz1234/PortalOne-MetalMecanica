				...
				<div class="col-lg-8">
					<div class="form-group">
						...
						<div class="col-lg-9">
							...
							<input name="CardName" type="text" required="required" class="form-control" id="CardName" placeholder="Digite para buscar..." value="<?php if(($edit==1)||($sw_error==1)){echo $row['NombreCliente'];}elseif($dt_LS==1||$dt_ET==1){echo $row_Cliente['NombreCliente'];}?>" <?php if((($edit==1)&&($row['Cod_Estado']=='C'))||($dt_LS==1||$dt_ET==1)){echo "readonly";}?>>
						</div>
					</div>
					<div class="form-group">
