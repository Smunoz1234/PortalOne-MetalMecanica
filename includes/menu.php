      ...
      <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
			...
			<?php while($row_Menu=sqlsrv_fetch_array($SQL_Menu)){
                    ...
                    <ul class="nav nav-second-level collapse">
						...
						<?php if(PermitirFuncion(314)||PermitirFuncion(315)||PermitirFuncion(408)){?>
							<li>
								...
								<ul class='nav nav-third-level'>
									<li><a class="alnk" href="index1.php?id=<?php echo base64_encode('1');?>">Dashboard de servicios</a></li>
				...
				<?php }?>
				<?php if(PermitirFuncion(701)||PermitirFuncion(702)||PermitirFuncion(703)||PermitirFuncion(704)){?>
				<li>
