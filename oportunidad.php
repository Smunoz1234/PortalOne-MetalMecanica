...
function sumarDiasFecha(pFecha, pDias) {
	...
	let res = TuFecha.getFullYear() + '-' + (((TuFecha.getMonth() + 1).length=1) ? "0"+(TuFecha.getMonth() + 1) : (TuFecha.getMonth() + 1)) + '-' + TuFecha.getDate();
								   ...
								   <div id="tabOpr-1" class="tab-pane active">
									   <br>
										<div class="form-group">
											...
											<div class="col-lg-1">
												<input autocomplete="off" name="CierrePlan" type="text" required="required" class="form-control" id="CierrePlan" maxlength="10" value="" onChange="CalcularCierre();">
											</div>
											<div class="col-lg-1">
