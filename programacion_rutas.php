...
//		console.log('Agrego')
	...
	$.ajax({
		type: "POST",
		url: "programacion_rutas_calendario.php?type=1&pSede=<?php echo $Sede;?>&pTecnicos="+Tecnicos+"&pIdEvento=<?php if($sw==1){echo $row_Evento['IdEvento'];}?>&sw=<?php echo $sw;?>&fchinicial=<?php echo $FechaInicial;?>",
		success: function(response){
