...
<form id="from" name="form">
	...
	<table width="100%" class="table table-bordered">
		...
		<tr>
			...
			<td><input size="50" type="text" autocomplete="off" id="FreeTxt<?php echo $i;?>" name="FreeTxt[]" class="form-control" value="<?php echo $row['FreeTxt'];?>" onChange="ActualizarDatos('FreeTxt',<?php echo $i;?>,<?php echo $row['LineNum'];?>);" maxlength="100" <?php if($row['LineStatus']=='C'||(!PermitirFuncion(402))){echo "readonly";}?>></td>
