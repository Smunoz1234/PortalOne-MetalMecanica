...
if($type_llmd==1&&$sw_error==0){
	...
	//Numero de series
	$SQL_NumeroSerie=Seleccionar('uvw_Sap_tbl_TarjetasEquipos','*',"IdArticulo='".$row['IdArticuloLlamada']."'",'Serial');
...
if($sw_error==1){
	...
	//Panoramas de riesgos
	$SQL_FrmHallazgos=Seleccionar('uvw_tbl_FrmHallazgos','*',"ID_LlamadaServicio='".$row['DocEntry']."'",'ID_Frm');
              ...
              <form action="llamada_servicio.php" method="post" class="form-horizontal" enctype="multipart/form-data" id="CrearLlamada">
				...
				<div class="ibox">
					...
					<div class="ibox-content">	
						...
						<div class="form-group">					
							<label class="col-lg-1 control-label"><i onClick="ConsultarArticulo();" title="Consultar ID Servicio" style="cursor: pointer" class="btn-xs btn-success fa fa-search"></i> ID servicio <span class="text-danger">*</span></label>
							<div class="col-lg-7">
						...
						<div class="form-group">					
							<label class="col-lg-1 control-label">Número de serie</label>
							<div class="col-lg-3">
								<select name="NumeroSerie" class="form-control select2" id="NumeroSerie" <?php if(($type_llmd==1)&&(!PermitirFuncion(302)||($row['IdEstadoLlamada']=='-1'))){ echo "disabled='disabled'";}?>>
									...
									<?php if(($type_llmd==1)||($sw_error==1)){while($row_NumeroSerie=sqlsrv_fetch_array($SQL_NumeroSerie)){?>
										<option value="<?php echo $row_NumeroSerie['IdTarjetaEquipo'];?>" <?php if((isset($row_NumeroSerie['IdTarjetaEquipo']))&&(strcmp($row_NumeroSerie['IdTarjetaEquipo'],$row['IdNumeroSerie'])==0)){ echo "selected=\"selected\"";}?>><?php echo $row_NumeroSerie['Serial'];?></option>
									<?php }}?>
								</select>
							</div>
						</div>
						<div class="form-group">
							<label class="col-lg-1 control-label">Cantidad artículo</label>
							<div class="col-lg-3">
							...
							<label class="col-lg-1 control-label">Precio artículo</label>
							<div class="col-lg-3">
				...
				<div class="ibox">
					...
					<div class="ibox-content">
						<div class="form-group">
							...
							<label class="col-lg-1 control-label">Número de llamada</label>
							<div class="col-lg-2">
						...
						<div class="form-group">
							<label class="col-lg-1 control-label">Asunto de llamada <span class="text-danger">*</span></label>
							<div class="col-lg-5">
							...
							<label class="col-lg-1 control-label">Fecha de creación <span class="text-danger">*</span></label>
						...
						<div class="form-group">
							<label class="col-lg-1 control-label">Origen <span class="text-danger">*</span></label>
							<div class="col-lg-2">
							...
							<label class="col-lg-1 control-label">Tipo llamada <span class="text-danger">*</span></label>
							<div class="col-lg-2">
							...
							<label class="col-lg-1 control-label"><i onClick="ConsultarContrato();" title="Consultar Contrato servicio" style="cursor: pointer" class="btn-xs btn-success fa fa-search"></i> Contrato servicio</label>
							<div class="col-lg-2">
							...
							<label class="col-lg-1 control-label">Hora de creación <span class="text-danger">*</span></label>
						...
						<div class="form-group">
							<label class="col-lg-1 control-label">Tipo problema <span class="text-danger">*</span></label>
							<div class="col-lg-2">
							...
							<label class="col-lg-1 control-label">SubTipo problema <span class="text-danger">*</span></label>
							<div class="col-lg-2">
				...
				<div class="ibox">
					...
					<div class="ibox-content">
						<div class="form-group">
							...
							<label class="col-lg-1 control-label">Estado de servicio <span class="text-danger">*</span></label>
							<div class="col-lg-3">
						...
						<div class="form-group">
							...
							<label class="col-lg-1 control-label">Cancelado por <span class="text-danger">*</span></label>
							<div class="col-lg-3">
				...
				<div class="ibox">
					...
					<div class="ibox-content">
						...
						<div class="form-group">
							<label class="col-lg-1 control-label">Fecha de cierre <span class="text-danger">*</span></label>
							<div class="col-lg-2 input-group date">
							...
							<label class="col-lg-1 control-label">Hora de cierre <span class="text-danger">*</span></label>
							<div class="col-lg-2 input-group clockpicker" data-autoclose="true">
